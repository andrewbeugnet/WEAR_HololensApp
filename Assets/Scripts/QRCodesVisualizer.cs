            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        qrCodeObject.GetComponent<SpatialGraphCoordinateSystem>().Id = action.qrCode.SpatialGraphNodeId;//can use this later to store QR ids, and check them to change form
